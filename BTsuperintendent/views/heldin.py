...
from BTsuperintendent.forms import HeldInForm
from BTsuperintendent.models import BTHeldIn
...
def update_heldin(request):
    if request.method == 'POST':
        ...
        if form.is_valid() and 'submit-form' in request.POST.keys():
            ...
            return render(request, 'BTsuperintendent/HeldIn.html', {'form':form, 'msg':msg})
            ...
            if prev_obj:
                ...
                return render(request, 'BTsuperintendent/HeldIn.html', {'form':form, 'month':held_in_month, 'year':held_in_year})
    else:
        form = HeldInForm()
    return render(request, 'BTsuperintendent/HeldIn.html', {'form':form})