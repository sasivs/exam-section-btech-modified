...
from BTsuperintendent.forms import CourseStructureForm, CourseStructureDeletionForm, CourseStructureStatusForm
    ...
    if request.method == 'POST':
        ...
        if request.POST.get('Submit'):
            if form.is_valid():
                ...
                return render(request, 'BTsuperintendent/CourseStructure.html', {'form':form, 'invalidRows':invalidDataset, 'errorData':errorData, 'msg':msg, 'invalid_data_msg':invalid_data_msg, 'error_data_msg':error_data_msg})
...
def course_structure_status(request):
    if(request.method=='POST'):
        ...
        if form.is_valid():
            ...
            return render(request, 'BTsuperintendent/BTCourseStructureStatus.html',{'form':form, 'coursestructure':course_structure})
    else:
        form = CourseStructureStatusForm()
    return render(request, 'BTsuperintendent/BTCourseStructureStatus.html',{'form':form})
