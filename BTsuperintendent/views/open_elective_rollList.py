        ...
        if 'submit-form' in request.POST.keys():
            if form.is_valid() and request.POST['regid'] != 'Choose Event' and request.POST['sub'] != 'Choose Subject' and request.POST['file'] != '':
                ...
                if(not result.has_errors()):
                    ...
                    return render(request, 'BTsuperintendent/OpenElectiveRollList.html',{'form':form, 'msg':msg})
                else:
                    ...
                    return render(request,'BTsuperintendent/BTOERoleListErrorHandler.html',{'errorrows':OERollsErrRows})
                    
        return render(request, 'BTsuperintendent/OpenElectiveRollList.html',{'form':form})
    else:
