...
def grade_points_upload(request):
        ...
        if form.is_valid():
            if form.cleaned_data['Regulation'] != '-- Select Regulation --':
                ...
                if not result.has_errors():
                    ...
                    return(render(request,'BTsuperindent/GradePointsUpload.html', {'form':form, 'msg':msg}))
                else:
    ...
    return render(request, 'BTsuperindent/GradePointsUpload.html', {'form':form})
...
def grade_points_upload_error_handler(request):
    ...
    if(request.method=='POST'):
        ...
        if(form.is_valid()):
            ...
            return render(request, 'BTsuperindent/GradePointsUploadSuccess.html')
    else:
        form = GradePointsUpdateForm(Options=errRows)
    return(render(request, 'BTsuperindent/GradePointsUploadErrorHandler.html',{'form':form}))
...
def grade_points_status(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'BTsuperindent/GradePointsStatus.html', {'form':form, 'grade_points':grade_points_obj})
    form = GradePointsStatusForm()
    return render(request, 'BTsuperindent/GradePointsStatus.html', {'form':form})
