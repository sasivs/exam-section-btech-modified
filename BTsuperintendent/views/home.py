...
def sup_home(request):
    return render(request,'BTsuperindent/suphome.html')
...
def registration_home(request):
    return render(request,'BTsuperindent/registrationhome.html')

@login_required(login_url="/login/")
@user_passes_test(grades_home_access)
def grades_home(request):
    return render(request, 'BTsuperindent/grades_home.html')

@login_required(login_url="/login/")
@user_passes_test(pre_registrations_home_access)
def pre_registrations_home(request):
    return render(request, 'BTsuperindent/preRegistrations_home.html')

@login_required(login_url="/login/")
@user_passes_test(is_Superintendent)
def branch_change_home(request):
    return render(request, 'BTsuperindent/branchChange_home.html')

@login_required(login_url="/login/")
@user_passes_test(roll_list_status_access)
def rolllist_home(request):
    return render(request, 'BTsuperindent/rollList_home.html')

@login_required(login_url="/login/")
@user_passes_test(not_promoted_home_access)
def not_promoted_home(request):
    return render(request, 'BTsuperindent/not_promoted_home.html')


@login_required(login_url="/login/")
@user_passes_test(faculty_home_access)
def faculty_home(request):
    return render(request, 'BTsuperindent/faculty_home.html')

@login_required(login_url="/login/")
@user_passes_test(marks_home_access)
def marks_home(request):
    return render(request, 'BTsuperindent/marks_home.html')

@login_required(login_url="/login/")
@user_passes_test(user_management_home_access)
def userassignment_home(request):
    return render(request, 'BTsuperindent/userassignment_home.html')


@login_required(login_url="/login/")
@user_passes_test(is_Superintendent)
def cancellation_home(request):
    return render(request, 'BTsuperindent/registrationcancellation.html')


@login_required(login_url="/login/")
@user_passes_test(subject_home_access)
def subject_home(request):
    return render(request, 'BTsuperindent/subjecthome.html')

@login_required(login_url="/login/")
@user_passes_test(registration_status_access)
def btech_registration_status_home(request):
    return render(request, 'BTsuperindent/registrationstatus.html')
