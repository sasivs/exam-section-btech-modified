...
from SupExamDBRegistrations.forms import BacklogRegistrationForm, GradePointsUploadForm, RegistrationsEventForm, \
...
def grade_points_upload(request):
            ...
            if form.cleaned_data['Regulation'] != '-- Select Regulation --':
                ...
                if not result.has_errors():
                    ...
                    if len(errorDataset)!=0:
                        ...
                        return HttpResponseRedirect(reverse('GradePointsUploadErrorHandler' ))
                    return(render(request,'SupExamDBRegistrations/GradePointsUploadSuccess.html')) 
                else:
    ...
    return render(request, 'SupExamDBRegistrations/GradePointsUpload.html', {'form':form})
...
def grade_points_upload_error_handler(request):
    ...
    return(render(request, 'SupExamDBRegistrations/GradePointsUploadErrorHandler.html',{'form':form}))
