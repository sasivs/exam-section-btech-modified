...
from ..forms import  BRegistrationsEventForm, RegistrationsEventForm, RegularRegistrationsStatusForm, BacklogRegistrationSummaryForm,\
    MakeupRegistrationSummaryForm
...
def btech_backlog_registration_status(request):
    ...
    return render(request, 'SupExamDBRegistrations/Status/BTBacklogRegistrationStatus.html',
...
def btech_makeup_registration_status(request):
    ...
    return render(request, 'SupExamDBRegistrations/Status/BTMakeupRegistrationStatus.html',
                    { 'studentRegistrations':studentRegistrations ,'form':form, 'heading' :heading }  )
