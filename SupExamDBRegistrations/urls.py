...
from BTsuperintendent.views import add_regulation, branch_change, create_registration_event, grade_points, home, open_elective_registrations
...
urlpatterns = [
    ...
    # path('FacultyAssignment', FacultyInfo.faculty_assignment, name = 'FacultyAssignment'),
    # path('FacultyAssignmentStatus', FacultyInfo.faculty_assignment_status, name = 'FacultyAssignmentStatus'),
    # path('FacultyAssignemntDetail/<int:pk>', FacultyInfo.faculty_assignment_detail, name='FacultyAssignmentDetail'),
