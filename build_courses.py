...
def build_course_structure(file):
    ...
    print(cs_file)
    cs_file.to_csv("/home/examsection/Desktop/awsp_testing_v2/database_recreate/course_structure_from_2019.xlsx")
...
def build_courses_file(file):
    ...
    distribution_string = t_marks+';'+str(mark_dis.PromoteThreshold)+';'+dis_names
    # distribution_string_2 = '100+100+100+100;0+0+0+15;Minor-I+Mid+Minor-II+End'
