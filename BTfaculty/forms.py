...
class MarksStatusUpdatedForm(forms.Form):
    def __init__(self, subjects, *args,**kwargs):
        super(MarksStatusUpdatedForm, self).__init__(*args, **kwargs)
        subject_Choices=[]
        if subjects:
            for sub in subjects:
...
class MarksStatusForm(forms.Form):
    '''
    This form is used in GradesThreshold and various other views.
    '''
    def __init__(self, subjects, *args,**kwargs):
