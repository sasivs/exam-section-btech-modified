...
urlpatterns = [
    ...
    path('SupBTRegistrationHome', views.registraion_home, name = 'SupBTRegistrationHome'),
    path('SupBTRegistrationUpload', views.btech_regular_registraion_upload, name = 'SupBTRegistrationUpload'),
    path('SupBTRegistrationUploadErrorHandler', views.btech_regular_registraion_upload_error_handler, name = 'SupBTRegistrationUploadErrorHandler'),
