...
from BTco_ordinator.forms import MDARegistrationsForm
...
def mda_elective_regs_upload(request):
    user = request.user
    ...
    if(request.method == "POST"):
        form = MDARegistrationsForm(regIDs,request.POST,request.FILES)
        ...
        form = MDARegistrationsForm(regIDs)
