...
urlpatterns = [
    ...
    # path('BTFacultyInfoUpload', BTFacultyInfo.faculty_upload, name = 'BTFacultyInfoUpload'),
    # path('BTFacultyInfoUploadErrorHandler', BTFacultyInfo.BTFacultyInfo_upload_error_handler, name = 'BTFacultyInfoUploadErrorHandler'),
    # path('BTFacultyInfoStatus', BTFacultyInfo.BTFacultyInfo_upload_status, name = 'BTFacultyInfoStatus'),
    # path('BTFacultyInfoDeletion', BTFacultyInfo.Faculty_delete, name = 'BTFacultyInfoDeletion'),
    # path('FacultyAssignment', BTFacultyInfo.faculty_assignment, name = 'FacultyAssignment'),
    # path('FacultyAssignmentStatus', BTFacultyInfo.faculty_assignment_status, name = 'FacultyAssignmentStatus'),
    # path('FacultyAssignemntDetail/<int:pk>', BTFacultyInfo.faculty_assignment_detail, name='FacultyAssignmentDetail'),
